...
for (let key in myPet) { console.log("Q3: " + key + ":", myPet[key]) }
...
myPet.describe = function () { return `${myPet.name} is a ${this.color} ${this.species}` }
console.log("Q4: ", myPet.describe());
...
const myCat = { name: "Tom", species: "australian", color: "brown" };
const myDog = { name: "Bull", species: "mexican", color: "black" };
const myRat = { name: "Jerry", species: "american", color: "blue" };

const pets = [myCat, myDog, myRat];
...
let dog1 = new Dog("Rocky", "bulldog", 5);
let dog2 = new Dog("Luna", "husky", 3);
...
const dog3 = { name: "Buddy", breed: "Labrador", age: 3 };
const dog4 = { name: "Buddy", breed: "Labrador", age: 3, color: "brown" };
...
let month = currentDate.getMonth(); // 0 = January
